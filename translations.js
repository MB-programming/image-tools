...
const translations = {
    ar: {
        ...
        'tool-to-pdf-title': 'التحويل إلى PDF',
        'tool-to-pdf-desc': 'تحويل الصور والمستندات والنصوص إلى PDF مع دعم العربية',
        'tool-pdf-editor-title': 'محرر PDF',
        'tool-pdf-editor-desc': 'تحرير ملفات PDF: إضافة نص، توقيع، حذف عناصر، إدارة الصفحات - دعم كامل للعربية',
        'tool-to-word-title': 'التحويل إلى Word',
        'tool-to-word-desc': 'تحويل الصور والنصوص إلى مستندات Word مع التنسيق',
        'tool-to-excel-title': 'التحويل إلى Excel',
        'tool-to-excel-desc': 'تحويل الجداول والبيانات إلى جداول Excel',
        'upload-pdf-note': 'يدعم الصور، ملفات النصوص، HTML - رفع جماعي مدعوم',
        'upload-pdf-edit': 'ارفع PDF للتحرير',
        'upload-pdf-edit-note': 'دعم كامل للتحرير مع النص العربي',
        'upload-word-note': 'تحويل إلى مستند Word',
        'pdf-title': 'عنوان المستند:',
        'pdf-orientation': 'الاتجاه:',
        'portrait': 'عمودي',
        'landscape': 'أفقي',
        'btn-create-pdf': 'إنشاء PDF',
        'btn-create-word': 'إنشاء Word',
        'btn-create-excel': 'إنشاء Excel',
        'add-text': 'إضافة نص',
        'add-signature': 'توقيع',
        'delete': 'حذف',
        'add-page': 'إضافة صفحة',
        'delete-page': 'حذف صفحة',
        'save-pdf': 'حفظ PDF',
        'excel-input-title': 'أدخل بيانات الجدول',
        'excel-separator': 'الفاصل:',
        'word-title': 'عنوان المستند:',
    ...
    en: {
        ...
        'tool-to-pdf-title': 'Convert to PDF',
        'tool-to-pdf-desc': 'Convert images, documents, and text to PDF with Arabic support',
        'tool-pdf-editor-title': 'PDF Editor',
        'tool-pdf-editor-desc': 'Edit PDF files: add text, sign, delete elements, manage pages - Full Arabic support',
        'tool-to-word-title': 'Convert to Word',
        'tool-to-word-desc': 'Convert images and text to Word documents with formatting',
        'tool-to-excel-title': 'Convert to Excel',
        'tool-to-excel-desc': 'Convert tables and data to Excel spreadsheets',
        'upload-pdf-note': 'Supports images, text files, HTML - Bulk upload supported',
        'upload-pdf-edit': 'Upload PDF to Edit',
        'upload-pdf-edit-note': 'Full editing support with Arabic text',
        'upload-word-note': 'Convert to Word document',
        'pdf-title': 'Document Title:',
        'pdf-orientation': 'Orientation:',
        'portrait': 'Portrait',
        'landscape': 'Landscape',
        'btn-create-pdf': 'Create PDF',
        'btn-create-word': 'Create Word',
        'btn-create-excel': 'Create Excel',
        'add-text': 'Add Text',
        'add-signature': 'Sign',
        'delete': 'Delete',
        'add-page': 'Add Page',
        ...
        'save-pdf': 'Save PDF',
        'excel-input-title': 'Enter Table Data',
        'excel-separator': 'Separator:',
        'word-title': 'Document Title:',
    ...
    de: {
        ...
        'tool-to-pdf-title': 'In PDF Konvertieren',
        'tool-to-pdf-desc': 'Bilder, Dokumente und Text in PDF mit arabischer Unterstützung konvertieren',
        'tool-pdf-editor-title': 'PDF-Editor',
        'tool-pdf-editor-desc': 'PDF bearbeiten: Text hinzufügen, signieren, Elemente löschen, Seiten verwalten',
        'tool-to-word-title': 'In Word Konvertieren',
        'tool-to-word-desc': 'Bilder und Text in Word-Dokumente konvertieren',
        'tool-to-excel-title': 'In Excel Konvertieren',
        'tool-to-excel-desc': 'Tabellen und Daten in Excel konvertieren',
        'upload-pdf-note': 'Unterstützt Bilder, Textdateien, HTML',
        'upload-pdf-edit': 'PDF zum Bearbeiten hochladen',
        'upload-pdf-edit-note': 'Vollständige Bearbeitung mit arabischem Text',
        'upload-word-note': 'In Word-Dokument konvertieren',
        'pdf-title': 'Dokumenttitel:',
        'pdf-orientation': 'Ausrichtung:',
        'portrait': 'Hochformat',
        'landscape': 'Querformat',
        'btn-create-pdf': 'PDF Erstellen',
        'btn-create-word': 'Word Erstellen',
        'btn-create-excel': 'Excel Erstellen',
        'add-text': 'Text Hinzufügen',
        'add-signature': 'Signieren',
        'delete': 'Löschen',
        'add-page': 'Seite Hinzufügen',
        'delete-page': 'Seite Löschen',
        'save-pdf': 'PDF Speichern',
        'excel-input-title': 'Tabellendaten Eingeben',
        'excel-separator': 'Trennzeichen:',
        'word-title': 'Dokumenttitel:',
    ...
    ru: {
        ...
        'tool-to-pdf-title': 'Конвертировать в PDF',
        'tool-to-pdf-desc': 'Конвертируйте изображения, документы и текст в PDF с поддержкой арабского языка',
        'tool-pdf-editor-title': 'Редактор PDF',
        'tool-pdf-editor-desc': 'Редактирование PDF: добавление текста, подпись, удаление элементов, управление страницами',
        'tool-to-word-title': 'Конвертировать в Word',
        'tool-to-word-desc': 'Конвертируйте изображения и текст в документы Word',
        'tool-to-excel-title': 'Конвертировать в Excel',
        'tool-to-excel-desc': 'Конвертируйте таблицы и данные в Excel',
        'upload-pdf-note': 'Поддерживает изображения, текстовые файлы, HTML',
        'upload-pdf-edit': 'Загрузить PDF для редактирования',
        'upload-pdf-edit-note': 'Полная поддержка редактирования с арабским текстом',
        'upload-word-note': 'Конвертировать в документ Word',
        'pdf-title': 'Название документа:',
        'pdf-orientation': 'Ориентация:',
        'portrait': 'Вертикальная',
        'landscape': 'Горизонтальная',
        'btn-create-pdf': 'Создать PDF',
        'btn-create-word': 'Создать Word',
        'btn-create-excel': 'Создать Excel',
        'add-text': 'Добавить Текст',
        'add-signature': 'Подписать',
        'delete': 'Удалить',
        'add-page': 'Добавить Страницу',
        'delete-page': 'Удалить Страницу',
        'save-pdf': 'Сохранить PDF',
        'excel-input-title': 'Ввести Данные Таблицы',
        'excel-separator': 'Разделитель:',
        'word-title': 'Название документа:',
